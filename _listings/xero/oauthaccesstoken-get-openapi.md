...
x-complete: 0
info:
  title: Xero oAuth 1a Access Token
...
paths:
  ...
  /oauth/RequestToken:
    get:
      ...
      description: 'TODO: Add Description'
      operationId: OauthRequestTokenGet
      x-api-path-slug: oauthrequesttoken-get
      responses:
        200:
          description: OK
      tags:
  ...
  /oauth/AccessToken:
    get:
      ...
      description: 'TODO: Add Description'
      operationId: OauthAccessTokenGet
      x-api-path-slug: oauthaccesstoken-get
      parameters:
      - in: query
        name: oauth_verifier
      responses:
